...
export const WhatIBuild: React.FC = () => {
  return (
    <section className="relative bg-white text-[#111111] py-20 sm:py-28 overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 max-w-5xl mx-auto">
          {buildAreas.map((area, idx) => (
            <motion.div
              ...
              whileHover={{ y: -5 }}
              className="p-8 rounded-3xl bg-white border border-gray-200/90 shadow-md shadow-black/5 hover:border-[#FF7A2F]/50 hover:shadow-xl transition-all duration-300 flex flex-col justify-between"
            >
              <div>
